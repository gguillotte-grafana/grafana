...
func ProvideHTTPServer(opts ServerOptions, cfg *setting.Cfg, routeRegister routing.RouteRegister, bus bus.Bus,
	...
	dashboardsnapshotsService *dashboardsnapshots.Service, commentsService *comments.Service, starsService stars.Manager, pluginSettings *pluginsettings.ServiceImpl,
) (*HTTPServer, error) {
	web.Env = cfg.Env
	m := web.New()
